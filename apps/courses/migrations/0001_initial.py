    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('1', 'Python'), ('2', 'Java'), ('3', 'C/C++'), ('4', 'Android'), ('5', '数据结构'), ('6', '人工智能')], default=1, max_length=20, verbose_name='课程类别')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('learn_times', models.IntegerField(default=0, verbose_name='学习时长(分钟数)')),
                ('url', models.CharField(default='', max_length=300, verbose_name='访问地址')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
